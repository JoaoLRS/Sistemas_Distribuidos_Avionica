"""
=================================================================
  Voter Consensual do Motor — TMR (Triple Modular Redundancy)
  Integrante: Gabriela
=================================================================
  Consome telemetria dos 3 motores via Kafka e aplica votação:
    - Se variação < 5%: média aritmética dos 3
    - Se 1 motor diverge > 5%: descarta e faz média dos 2
    - Se todos divergem: alerta crítico (falha bizantina)
  Publica resultado consolidado em Kafka.
=================================================================
"""
...
def main():
    print("=" * 60, flush=True)
    print("  ⚖️  TMR Voter — Redundância Modular Tripla (Gabriela)", flush=True)
    print("=" * 60, flush=True)
